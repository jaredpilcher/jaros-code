...
def test_roster_size_unchanged():
    # bumped 19 -> 22 -> 26 -> 30: EXT-060 REQ-28/29/30 (tests/test_ext060_clock_agent_tasks.py)
    # added three more CREATE tasks after this module's own REQ-23 landed, then REQ-31..34
    # (tests/test_ext060_atlas_wave2_tasks.py) and REQ-40..43 (tests/test_ext060_atlas_wave7_
    # tasks.py) each added four more. The CREATE count is still unchanged by this file. MODIFY
    # bumped 6 -> 11: REQ-35..39 (tests/test_ext060_modify_wave2.py) added five more MODIFY
    # tasks, growing the previously lopsided 26-CREATE-vs-6-MODIFY split (now 30-vs-11).
