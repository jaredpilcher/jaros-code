...
def test_real_systems_tasks_roster_grew_by_the_four_new_wave7_tasks():
    # bumped 26 -> 30 -> 34 -> 38 -> 42 -> 46 -> 50: this module's own REQ-40/41/42/43 add four more
    # CREATE tasks, then REQ-44..47 (tests/test_ext060_atlas_batch4_tasks.py) added four more,
