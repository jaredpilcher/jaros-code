...
_PROMPT = (
    ...
    "Common pitfalls to avoid: RETURN the required value (do not print it); match the EXACT "
    "expected output (exact strings, list order, types); when comparing text, apply the "
    "case/whitespace handling the task asks for; check loop boundaries for off-by-one.\n\n"
