...
def test_route_intent():
    ...
    assert ri("explain fix_loop") == ("explain", "fix_loop")
    assert ri("what does fix_loop do") == ("explain", "fix_loop")
    assert ri("describe the build_repo_map function") == ("explain", "build_repo_map")
