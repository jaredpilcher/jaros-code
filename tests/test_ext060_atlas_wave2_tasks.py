...
def test_real_systems_tasks_roster_grew_by_the_four_new_tasks():
    # bumped 22 -> 26 -> 30 -> 34 -> 38 -> 42 -> 46: this module's own REQ-31/32/33/34 add four
    # more CREATE tasks, then EXT-060 REQ-40..43 (tests/test_ext060_atlas_wave7_tasks.py) added
    # four more, then REQ-44..47 (tests/test_ext060_atlas_batch4_tasks.py) added four more, then
